...
// ============================================================
// SIDEBAR ĐIỀU HƯỚNG CHÍNH - GIỮ NGUYÊN GIAO DIỆN GỐC
// ============================================================
// Mục đích: Hiển thị menu điều hướng dựa trên vai trò của user
// - Hiển thị menu theo role
// - Badge cho menu đặc biệt (HR, Leader)
// - Thông tin user và trạng thái
// ============================================================
...
interface SidebarProps {
  ...
  setActiveTab: (tab: string) => void; // Hàm đổi tab
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  // Lọc menu items theo vai trò của user
